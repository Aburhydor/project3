document.addEventListener('DOMContentLoaded', function () {
  ...
  form.addEventListener('submit', function (e) {
    ...
    var gitHub = document.getElementById('result').innerHTML;
    ...
    fetch('https://api.github.com/users/' + users)
      ...
      .then((data) => {
        ...
        <li id="fol">Followers: ${data.followers}</li>
  ...
  function batResult() {
    var bat = document.getElementById('bat').innerHTML;
    localStorage.setItem('myBat', bat);
  }

  var d = localStorage.getItem('myBat');
  console.log('The Value Received is ' + d);
